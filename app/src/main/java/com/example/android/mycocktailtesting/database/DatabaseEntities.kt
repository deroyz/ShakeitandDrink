...
@Entity(tableName = "latestdrinks")
data class DatabaseLatestDrink constructor(
    @PrimaryKey
    val idDrink: Double,
    val strDrink: String,
    val strCategory: String,
...
data class DatabaseFavoriteDrink constructor(
    @PrimaryKey
    val idDrink: Double,
    val strDrink: String,
    val strCategory: String,
...
fun List<DatabasePopularDrink>.asDomainModelPopularDrink(): List<Drink> {
...
fun List<DatabaseLatestDrink>.asDomainModelLatestDrink(): List<Drink> {
...
fun List<DatabaseFavoriteDrink>.asDomainModelFavoriteDrink(): List<Drink> {
